...
도주거리가 늘어날수록 수배 등급이 상승하며, AI 판결문·체포메모·현실 복귀 미션을 통해 자신의 현실도피를 유쾌하게 돌아보고 다시 시작할 수 있습니다.

현실도피라는 누구나 공감할 수 있는 행동을 하나의 세계관과 놀이 경험으로 재해석하고, 사용자가 부담 없이 현실로 복귀할 수 있도록 돕는 서비스입니다.
...
- AI 기반 판결문, 체포메모, 현실 복귀 미션 생성
- 결과 카드 저장 기능을 통한 SNS 공유 경험 제공
...
사용자가 부담 없이 시작할 수 있는 가장 작은 행동을 제안합니다.
...
AI는 사용자가 지금 당장 시작할 수 있는 가장 쉬운 첫 행동을 제안하여 현실 복귀를 돕습니다.
...
에 따라 완전히 다른 판결문, 체포메모, 현실 복귀 미션이 생성됩니다.

단순히 웃고 끝나는 것이 아니라 사용자가 다시 현실로 돌아갈 수 있는 작은 시작점을 제공합니다.
...
또한 사용자가 가장 작은 행동부터 다시 시작할 수 있도록 도와, 현실 복귀의 진입장벽을 낮추는 것을 목표로 합니다.

### 🚔 DOJU

**심리적·시간적으로 미뤄둔 현실의 거리를 물리적 도주거리(km)로 환산하고, AI가 현실 복귀를 돕는 현실도피 추적 서비스**
